            ...
            <DashboardLayout title="Dashboard">
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
                    {stats.map((stat) => {
                        ...
                        const href = stat.label === 'Total Clients' ? '/clients' : stat.label === 'Open Tickets' ? '/support' : stat.label === 'Total Billing' || stat.label === 'Total Spent' ? '/invoices' : stat.label === 'Active Projects' ? '/projects?status=in_progress' : stat.label === 'Projects Completed' ? '/projects?status=completed' : '/projects';
                        return (
