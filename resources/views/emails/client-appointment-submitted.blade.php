...
<body style="font-family:sans-serif;padding:24px;background:#f1f5f9">
    <div style="max-width:560px;margin:0 auto;background:white;border-radius:12px;padding:32px">
        ...
        <p style="color:#64748b;margin:0 0 24px">Thank you for reaching out to {{ config('app.name') }}. Your appointment request has been received.</p>
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px">
            ...
            <tr><td style="padding:8px 0;color:#64748b">Contact</td><td style="font-weight:600;color:#0f172a">{{ $projectRequest->contact_name }}</td></tr>
