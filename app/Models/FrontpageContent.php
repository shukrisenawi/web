...
class FrontpageContent extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'game_development_hero_avatars' => 'array',
            'home_hero' => 'array',
            'services_hero' => 'array',
    ...
    public static function defaultRecord(): array
    {
        return [
            ...
            'digital_marketing_hero_avatars' => [
                ['image' => 'https://i.pravatar.cc/150?img=11'],
                ['image' => 'https://i.pravatar.cc/150?img=12'],
                ['image' => 'https://i.pravatar.cc/150?img=13'],
            ],
            ...
            'stats' => [
                ...
                ['icon' => 'Rocket', 'value' => '5+', 'label' => 'Years of\nExperience'],
                ['icon' => 'Globe', 'value' => '10+', 'label' => 'Industries\nServed'],
                ['icon' => 'TrendingUp', 'value' => '85%', 'label' => 'Client\nGrowth'],
            ],
            ...
            'payment_logo' => '/images/qr.png',
            'payment_accepted_logo' => '/images/logo-payment-accepted.png',
